...
const createStoreDrawer = ref(false)
const closeAddGoodsDrawer = () => {
  addGoodsDrawer.value = false
}
const closeCreateStoreDrawer = () => {
  createStoreDrawer.value = false
}
...
<template>
  <el-main class="main-container">
    <el-card class="aside-card">
      ...
      <el-button type="primary" id="create-store-button" v-if="role === 'MANAGER'" @click="createStoreDrawer = true">创建商店</el-button>

      <el-button type="primary" id="create-store-button" v-if="role === 'STAFF'" @click="addGoodsDrawer = true">添加商品</el-button>
